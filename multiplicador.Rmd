...
```{r echo = FALSE, message=FALSE, warning=FALSE, fig.cap = "Plot Série Temporal do Multiplicador Monetário do Período da Lauda"}
...
```{r echo = FALSE, message=FALSE, warning=FALSE, fig.cap = "Plot Série Temporal do coeficiente \"e\" do Período da Lauda"}
