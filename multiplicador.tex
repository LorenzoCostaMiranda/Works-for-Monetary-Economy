...
variável monetária é função de outras duas, o coeficiente ``e'' e o
...
multiplicador, pois sabe-se que ao aumentar esse encaixe, os bancos
...
pagamento. Essa fração nada mais indica o quão ativos estão os bancos
comerciais e em que proporção oferecem empréstimos e crétidos em relação
aos meios de pagamentos totais da economia (PPMP +
DV\textsubscript{bc}). Dessa forma, o ``d'' é um indicador da atuação
dos bancos comerciais, e tem relação direta com o multiplicador.
...
\caption{Plot Série Temporal do coeficiente ``e'' do Período da Lauda}
\end{figure}	
