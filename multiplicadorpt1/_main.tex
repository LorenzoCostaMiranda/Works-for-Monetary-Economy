...
\caption{\label{fig:unnamed-chunk-6}Plot da Série Temporal do Coeficiente ``e''}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/unnamed-chunk-7-1.pdf}
\caption{\label{fig:unnamed-chunk-7}Plot da Série Temporal do Coeficiente ``d''}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/unnamed-chunk-8-1.pdf}
\caption{\label{fig:unnamed-chunk-8}Plot da Série Temporal dos Coeficientes ``e'' e ``d''}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/unnamed-chunk-9-1.pdf}
\caption{\label{fig:unnamed-chunk-9}Plot Série Temporal do Multiplicador Monetário}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/unnamed-chunk-10-1.pdf}
\caption{\label{fig:unnamed-chunk-10}Plot Série Temporal do Multiplicador Monetário do Período da Copa}
\end{figure}

\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/unnamed-chunk-11-1.pdf}
\caption{\label{fig:unnamed-chunk-11}Plot Série Temporal do coeficiente ``e'' do Período da Copa}
\end{figure}
