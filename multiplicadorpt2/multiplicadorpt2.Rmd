...
vetorestatVARI <- c("Max", "Min", "Mean", "Median", "sd", "HighestVariance(%)", "LowestVariance(%)")
...
Observação: Para a análise geral, com o objetivo de melhor visualizaçao dos efeitos, foram realizado os gráficos com valores de médias anuais obtidos de valores mensais das variáveis. Para a análise específica, permaneceram os valores mensais das variáveis.
...
estatM1 <- c("653.420.212", "86.231.763", "311.794.154", "308.287.622","160.128.500", "22.87 (2007-12)", "-17.58 (2008-01)")
estatM2 <- c("5.913.356.669", "385.467.653", "2.066.000.000", "1.851.000.000", "1.407.171.000", "6.36 (2007-12)", "-3.12 (2008-01)")
estatM3 <- c("10.857.133.543", "696.054.502", "4.239.000.000", "3.789.000.000","2.822.259.000", "5.73 (2010-01)", "-1.26 (2019-01)")
estatM4 <- c("11.948.284.621", "810.272.451", "4.616.000.000", "4.084.000.000", "3.046.371.000", " 4.49 (2007-09)", "-0.87 (2019-01)")
estatPIB <- c("949003", "125711", "446063", "447130", "219.889,5", "13.42 (2004-03)", "-10,74 (2020-04)")
estatIPCA <- c("2.250 (2003-01)" , "-0.680 (2022-07)", "0.450", "0.450", "0,3563829", "2400 (2014-08)" ,"-1350 (2005-07)")
estatSELIC <- c("26.32 (2003-03)", "1.90 (2020-12)", "11.44", "11.38","4.863212", "-17.53 (2020-05)", "24.15 (2021-05)")


#Fazer as diferenças percentuais do multiplicador e das divisões 

diff_m1pib <- diff(tabeladiv$`M1/PIB`)
percentual_m1pib <- (diff_m1pib / head(tabeladiv$`M1/PIB`, -1)) * 100
vari_m1pib <- c(NA, percentual_m1pib)

diff_m2pib <- diff(tabeladiv$`M2/PIB`)
percentual_m2pib <- (diff_m2pib / head(tabeladiv$`M2/PIB`, -1)) * 100
vari_m2pib <- c(NA, percentual_m2pib)

diff_m3pib <- diff(tabeladiv$`M3/PIB`)
percentual_m3pib <- (diff_m3pib / head(tabeladiv$`M3/PIB`, -1)) * 100
vari_m3pib <- c(NA, percentual_m3pib)

diff_m4pib <- diff(tabeladiv$`M4/PIB`)
percentual_m4pib <- (diff_m4pib / head(tabeladiv$`M4/PIB`, -1)) * 100
vari_m4pib <- c(NA, percentual_m4pib)

variagregadoPIB <- tibble(Anos = Anos, "M1/PIB" = vari_m1pib, "M2/PIB" = vari_m2pib, "M3/PIB" = vari_m3pib, "M4/PIB" = vari_m4pib)

#summary(SerieTemporal_alpha)
#sapply(SerieTemporal_alpha, sd)
#summary(tabeladiv)
#sapply(tabeladiv, sd)
#summary(variagregadoPIB)
#sapply(variagregadoPIB, sd)

estatmulti <- c("1,604", "1,242", "1,426", "1,436","0,0816", "16,46 (2003-08)", "-10,14(2022-01")
estatm1pib <- c("0,0008273", "0,0006133", "0,0006986", "0.0006954", "0,00006429", "32.22 (2020)", "-12.09 (2022)")
estatm2pib <- c("0,006028", "0,002708", "0,004183", "0.004228", "0,0006028", "19.92 (2020)", "-4.48 (2010)")
estatm3pib <- c("0,011661", "0,005252", "0,008570", "0.008532", "0,002040", "10.56 (2020)", "-4.47 (2021)")
estatm4pib <- c("0,012508", "0,006013", "0,009388", "0.009171","0,002083", "9.66 (2020)", "-3.21 (2021)")

TabelaEstaAgPib <- tibble(Estatística = vetorestatVARI, "Multiplicador" = estatmulti, "M1/PIB" = estatm1pib, 
                          "M2/PIB" = estatm2pib, "M3/PIB" = estatm3pib, "M4/PIB" = estatm4pib)
...
tabeladiv <- tabeladiv %>%
  add_column( "(%)M1/PIB" = vari_m1pib, "(%)M2/PIB" = vari_m2pib, "(%)M3/PIB" = vari_m3pib, "(%)M4/PIB" = vari_m4pib,
              .after = "M4/PIB")

kable(tabeladiv, format = "html", longtable = TRUE, booktabs = TRUE) %>%
...
#### Estatística dos Agregados Monetários (Mensal)
...
#### Relação dos Agregados Monetários com o PIB em médias anuais

```{r echo = FALSE, message = FALSE, warning = FALSE}

kable(TabelaEstaAgPib, format = "html", longtable = TRUE, booktabs = TRUE) %>%
  kable_styling(bootstrap_options = c("stripped", "hover", "condesed"))
...
#### Gráficos dos Agregados Monetários, Taxa Selic e PIB em valores anuais
...
#### Estatística dos Agregados em valores mensais
...
imp_m1 <- c("347.220.589", "308.941.546", "318.176.364", "315.502.754","10.231.260", "7.21 (2015-12)", "-7.40 (2016-01)")
imp_m2 <- c("2.334.143.094", "2.200.717.397", "2.269.000.000", "2.284.000.000","45.630.950", "2.84 (2015-12)", "-1.43 (2016-01)")
imp_m3 <- c("5.008.017.964", "4.563.586.143", "4.773.000.000", "4.773.000.000","162.332.800", "2.92 (2015-12)", "-0.53 (2016-01)")
imp_m4 <- c("5.453.699.716", "4.951.069.509", "5.211.000.000", "5.228.000.000","177.033.800", "2.88 (2015-12)", "-0.38 (2016-01)")
imp_PIB <- c("528139", "481694", "507281", "510372","14.545,7", "7.68 (2016-03)", "-6.65 (2016-01)")
imp_IPCA <- c("1.27 (2016-01)", "0.2200 (2015-08)", "0.7458", "0.7850","0,2821495", "145.45 (2015-09)", "-64.51 (2015-08)")
imp_SELIC <- c("14.15 (2015-08)", "13.58 (2015-06)", "14.06", "14.15","0,2018306", "3.36 (2015-08)", "0 (2015-09 à 2016-05)")
