...
estatM1 <- c("653.420.212", "86.231.763", "311.848.406", "160.128.500", "22.87 (2007-12-01)", "-17.58 (2008-01-01)")
estatM2 <- c("5.913.000.000", "385.500.000", "2.066.000.000", "1.407.171.000", "6.36 (2007-12-01)", "-3.12 (2008-01-01)")
estatM3 <- c("10.860.000.000", "696.100.000", "4.239.000.000", "2.822.259.000", "5.73 (2010-01-01)", "-1.26 (2019-01-01)")
estatM4 <- c("11.950.000.000", "810.300.000", "4.616.000.000", "3.046.371.000", " 4.49 (2007-09-01)", "-0.87 (2019-01-01)")
...
par(new = TRUE)
plot(TabelaAgregados$Data, TabelaAgregados$IPCA, type = "l",
     col = "pink", axes = FALSE, xlab = "", ylab = "",
     ylim = c(min(TabelaAgregados$IPCA),
              max(TabelaAgregados$IPCA)))

axis(side = 4, at = pretty(range(TabelaAgregados$IPCA)))
mtext("Taxa Selic (%)", side = 4, line = 3)
...
mtext("Comparação Entre os Agregados e o IPCA", outer = TRUE, cex = 1.5, line = 2)
